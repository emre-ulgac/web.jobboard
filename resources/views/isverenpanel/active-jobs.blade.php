                        ...
                        @foreach($jobs->data as $job)
                            <tr>
                                ...
                                <td>
                                   ...
                                   <button  class="btn btn-primary dropdown-toggle" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">İşlem Yap</button>
                                    <input type="hidden" value="{{$job->slug}}" name="slug">

                                        <div class="dropdown-menu m--padding-15" aria-labelledby="dropdownMenuButton" >
                                            <a href="{{$job->slug}}/basvuranlar"><button class="btn btn-secondary menuFullWidth" style="width: 200px">Başvuru Görüntüle</button></a><br>
                                            <a href="{{'is-ilani-guncelle/'.$job->slug}}"><button class="btn btn-secondary menuFullWidth" style="width: 200px">Düzenle</button></a><br>
                                            <a href="/is-ilani/{{$job->slug}}"><button class="btn btn-secondary" style="width: 200px">İlana Git</button></a>
                                        </div>
