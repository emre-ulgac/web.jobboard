...
@section('content')
    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            ...
            -->                  <form class="m-form m-form--label-align-left- m-form--state-" action="{{route('job-post')}}"  method="POST" id="m_form">
                                                ...
                                                <div class="m-form__section m-form__section--first">
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                        ...
                                                        <div class="col-xl-9 col-lg-9">
                                                            <input type="text" name="title" class="form-control m-input" aria-describedby="name-error" aria-invalid="true" required  placeholder="Garsonluk, Stand Görevlisi"  id="p_title">
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                        ...
                                                        <div class="col-xl-9 col-lg-9">
                                                            <input type="number" name="fee" class="form-control m-input" placeholder="Ücret Giriniz" value="" id="ucret_22">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group m-form__group row ">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                                    ...
                                                                    <textarea class="summernote" name="description" id="summer" ></textarea>
                                            ...
                                            <div class="m-wizard__form-step" id="m_wizard_form_step_2">
                                                ...
                                                <div id="tek">
                                                    ...
                                                    <div class="form-group m-form__group row" id="day0">
                                                        ...
                                                        <div class="col-lg-6" >
                                                            <div class="input-group date">
                                                                <input type="text" class="form-control m-input tarih1"  name="tarih1" readonly placeholder="Tarih ve Zamanı Seçiniz" id="m_datetimepicker_2"/>
                                                    ...
                                                    <div class="form-group m-form__group row" id="day1">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="input-group date">
                                                                <input type="text" class="form-control m-input tarih2" name="tarih2" readonly placeholder="Tarih ve Zamanı Seçiniz" id="m_datetimepicker_2"/>
                                                                <div class="input-group-append">
													<span class="input-group-text">
														<i class="la la-calendar-check-o glyphicon-th"></i>
													</span>
                                                    ...
                                                    <div class="form-group m-form__group row" id="day2">
                                                        ...
                                                        <div class="col-lg-6" >
                                                            <div class="input-group date">
                                                                <input type="text" class="form-control m-input tarih3" name="tarih3" readonly placeholder="Tarih ve Zamanı Seçiniz" id="m_datetimepicker_2"/>
                                                                <div class="input-group-append">
													<span class="input-group-text">
														<i class="la la-calendar-check-o glyphicon-th"></i>
													</span>
                                                    ...
                                                    <div class="form-group m-form__group row" id="day3">
                                                        ...
                                                        <div class="col-lg-6" >
                                                            <div class="input-group date">
                                                                <input type="text" class="form-control m-input tarih4"  name="tarih4" readonly placeholder="Tarih ve Zamanı Seçiniz" id="m_datetimepicker_2"/>
                                                                <div class="input-group-append">
													<span class="input-group-text">
														<i class="la la-calendar-check-o glyphicon-th"></i>
													</span>
                                                ...
                                                <div class="m-form__section m-form__section--first">
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                        ...
                                                        <div class="col-xl-3 col-lg-3">
                                                            <div class="m-radio-inline">
                                                                <label class="m-checkbox">
                                                                    <input type="checkbox" id="adres" name="address" value="Belirsiz">
                                                                    Belirli bir adres yok
                                                                    <span></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <input type="text"  class="form-control m-input" name="address" placeholder="Adresi Giriniz" value="" id="adres_22">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="m-wizard__form-step" id="m_wizard_form_step_4">
                                                            ...
                                                            <div class="tab-content  m--padding-30">
                                                                <div class="m-form__section m-form__section--first">
                                                                    ...
                                                                    <div class="form-group m-form__group m-form__group--sm row">
                                                                        ...
                                                                        <div class="col-xl-8 col-lg-8">
																						<span class="m-form__control-static" id="parttarih23">

																						</span>

                                                                            <span class="m-form__control-static"  id="day111">

																						</span>

                                                                            <span class="m-form__control-static" id="day222">

																						</span>

                                                                            <span class="m-form__control-static" id="day333">
                                                ...
                                                <div class="form-group m-form__group m-form__group--sm row">
                                                    <div class="col-xl-12">
                                                        <div class="m-checkbox-inline">
                                                            <label class="m-checkbox m-checkbox--solid m-checkbox--brand">
                                                                ...
                                                                Click here to indicate that  agreement
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="m-checkbox-inline">
                                                            <label class="m-checkbox m-checkbox--solid m-checkbox--brand">
                                                                <input type="checkbox" name="taslak" value="1">
...
@section('job-post')
    ...
    <script src="assets/demo/default/custom/components/forms/widgets/form-repeater.js" type="text/javascript"></script>
