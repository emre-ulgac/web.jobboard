                            ...
                            <tr >
                                ...
                                <td style="text-align: center">
												...
												<span class="m-topbar__userpic">
													<img src="{{$user->image}}" class="m--img-rounded m--marginless m--img-centered w-25" alt=""/>
												</span>
                                ...
                                <td>
                                    ...
                                    <td>
                                        <a href="{{url('isci/'.$user->slug)}}" class="m-nav__link m-dropdown__toggle vc-hoverbox-width--50" ><button class="btn btn-primary">Profile Git</button>
                                        </a>
                                    </td>

                                <td>
                                    <a href="{{url('isci/'.$user->slug)}}" class="m-nav__link m-dropdown__toggle vc-hoverbox-width--50" ><button class="btn btn-default">Puanla</button>
                                    </a>
                                </td>
