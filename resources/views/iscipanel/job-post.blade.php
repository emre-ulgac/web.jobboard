                                            ...
                                            <div class="m-wizard__form-step m-wizard__form-step--current" id="m_wizard_form_step_1">
                                                <div class="m-form__section m-form__section--first">
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                        ...
                                                        <div class="m-radio-inline">
                                                            <label class="m-checkbox">
                                                                <input type="checkbox" name="kisisayisi" value="Belirsiz" id="chkPassport">
                                                                Belirsiz
                                                                <span></span>
                                                            </label>
                                                        </div>
														...
														<span class="input-group-text" id="basic-addon1">
                                                            ...
                                                            <input type="number" class="form-control m-input"  name="kisisayisi" placeholder="Gerekli çalışan sayısı" aria-describedby="basic-addon1" id="kisi_22">
                                                        </div>
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                        ...
                                                        <div class="m-radio-inline">
                                                            <label class="m-checkbox">
                                                                <input type="checkbox" id="kiyafet" name="kiyafet" value="belirsiz">
                                                                Belirsiz
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-6 col-lg-6" id="kiyafet2">
                                                            <input type="text" name="kiyafet" class="form-control m-input" placeholder="Takım elbise, turuncu t-shirt, beyaz gömlek" value="" id="kiyafet_2">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                        ...
                                                        <div class="m-radio-inline">
                                                            <label class="m-checkbox">
                                                                <input type="checkbox" id="ekipman" name="ekipman" value="belirsiz">
                                                                Belirsiz
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                        <div class="col-xl-6 col-lg-6" id="ekipman2">
                                                            <input type="text"  name="ekipman" class="form-control m-input" placeholder="Laptop, önlük, defter" value="" id="ekipman_2">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group m-form__group row m--margin-top-10">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                                <label >
                                                                    <textarea name="description" class="summernote" id="summer"></textarea>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="m-wizard__form-step" id="m_wizard_form_step_3">
                                                <div class="m-form__section m-form__section--first">
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input type="text"  class="form-control m-input" name="address" placeholder="" value="" id="adres_22">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input type="text"  class="form-control m-input" name="tarif" placeholder="" value="">
                                                        </div>
                                                    </div>
                                                </div>
